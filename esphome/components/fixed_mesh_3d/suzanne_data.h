...
// Compact Suzanne primitive data adapted from Blender's bmo_primitive.cc.
// Blender runtime source is GPL-2.0-or-later; ESPHome C++ runtime is GPLv3.
// The topology stores one half of Suzanne and reconstructs the mirrored half at runtime.
static constexpr int SUZANNE_OFFSET = 4;

static constexpr int8_t SUZANNE_VERTICES[][3] = {
...
static constexpr int8_t SUZANNE_FACES[][4] = {
...
static constexpr size_t SUZANNE_HALF_VERTEX_COUNT = sizeof(SUZANNE_VERTICES) / sizeof(SUZANNE_VERTICES[0]);
static constexpr size_t SUZANNE_HALF_FACE_COUNT = sizeof(SUZANNE_FACES) / sizeof(SUZANNE_FACES[0]);
static_assert(SUZANNE_HALF_VERTEX_COUNT == 271, "Unexpected Suzanne vertex table size");
static_assert(SUZANNE_HALF_FACE_COUNT == 250, "Unexpected Suzanne face table size");
